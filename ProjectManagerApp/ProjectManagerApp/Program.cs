...
namespace ProjectManagerApp
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var project2 = new Project("Drugi projekt", "izrada 2.projekta",DateTime.Now.AddDays(-60),DateTime.Now.AddDays(10),ProjectStatus.Finished);
            var project3 = new Project("Treci projekt", "izrada 3.projekta",DateTime.Now.AddDays(-20),DateTime.Now.AddDays(20),ProjectStatus.OnWait);
